# scripts/feature_extraction_fixed.py
"""
İç Mekan Benzerlik Arama Sistemi - Özellik Çıkarımı (Grafik Sorunu Düzeltildi)
...
class FeatureExtractor:
    ...
    def plot_pca_analysis(self, pca):
        """PCA analiz grafikleri (GUI olmadan)"""
